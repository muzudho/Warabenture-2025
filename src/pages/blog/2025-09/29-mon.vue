...
( 7)  相手番石  手番石      相手番石             内野はひっくり返る。観客席は既に相手番石で埋まっているので、この方向では外野は相手番に挟み返される心配がない</pre>
        ...
        内野    外野        観客席               コメント
----  --------  ----------  -------------------  --------
( 1)  盤外                                       盤端で空きスペースが無いので、この方向では、挟み返される心配がない
( 2)  空マス                                     逆側の［ｎ翼手］の配置によっては、［内野］の直近に［相手番石］を置かれたときに挟まれるかも
( 3)  相手番石  盤外                             盤端で空きスペースが無いので、この方向では、挟み返される心配がない
( 4)  相手番石  空マス                           既に相手番石で挟まれているので、挟み返される心配がない
( 5)  相手番石  手番石      盤外                 盤端で空きスペースが無いので、この方向では、挟み返される心配がない
( 6)  相手番石  手番石      空マス               逆側の［ｎ翼手］の配置によっては、［観客席］の直近に［相手番石］を置かれたときに挟まれるかも
( 7)  相手番石  手番石      相手番石             既に相手番石で挟まれているので、挟み返される心配がない</pre><br/>
